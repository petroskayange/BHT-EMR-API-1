class CreateReportingSymptoms < ActiveRecord::Migration[5.2]
  def change
    create_table :reporting_symptoms, primary_key: :symptom_id do |t|
    ...
    rename_column :reporting_symptoms, :value_coded_id, :value_coded
  end

  def down
    drop_table :reporting_symptoms
  end
end
