...
RSpec.describe Api::V1::RegistersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new register" do
        ...
        expect(response.location).to eq(register_url(Register.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the register" do
        register = Register.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the register" do
        register = Register.create! valid_attributes
